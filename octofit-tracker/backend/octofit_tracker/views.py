...
def api_root(request, format=None):
    ...
    # Usar la URL de Codespace para evitar problemas de HTTPS y permitir acceso desde localhost
    codespace_url = 'https://cautious-palm-tree-v7rwr677rq6hw54x-8000.app.github.dev/'
    return Response({
